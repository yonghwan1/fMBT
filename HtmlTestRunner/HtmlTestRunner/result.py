...
class _HtmlTestResult(_TextTestResult):
    ...
    def _get_info_by_testcase(self):
        ...
        for tests in (self.successes, self.failures, self.errors, self.skipped):
            for test_info in tests:
                ...
                # TODO: It is adhoc code
                #       It will have to be modified
                testcase_name = "smoke test"
    ...
    def _report_testcase(self, testCase, test_cases_list, testRunner):
        ...
        actualResult = ''
        try:
            messages = error_message.message.split('sep:sep')
            for i in range(3):
                if i == 0:
                    ...
                    try:
                        ...
                        if messages[i] != '':
                            ...
                            if destfile != "":
                                ...
                                expectedResult = "Failed to copy file: " + messages[i]
                    except Exception:
                        pass
                elif i == 2:
                    try:
                        ...
                        if messages[i] != '':
                            ...
                            if destfile != "":
                                ...
                                actualResult = "Failed to copy file: " + messages[i]
                    except Exception:
                        pass
        except Exception:
            pass
    ...
    def _report_suite(self, suite_name, tests, testRunner):
        ...
        for test in tests:
            self._report_testcase(test, test_cases_list, testRunner)
